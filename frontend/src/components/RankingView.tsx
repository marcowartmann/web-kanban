...
function ManualRow({
  ...
  return (
    <div
      ...
      } ${highlighted ? "border-blue-400 bg-blue-100 ring-1 ring-blue-300" : canMove ? "border-gray-200 bg-white" : "border-gray-200 bg-gray-50"}`}
          ...
          <div data-testid="wsjf-list" className="space-y-1">
            {wsjfOrder.map((f, i) => (
              <div
                ...
                className={`flex items-center gap-3 rounded-md border px-3 py-2 text-sm transition ${
                  hoveredId === f.id ? "border-blue-400 bg-blue-100 ring-1 ring-blue-300" : "border-gray-200 bg-white"
                }`}
              >
