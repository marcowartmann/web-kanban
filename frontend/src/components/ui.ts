...
export const btnSecondary =
  "rounded-lg border border-gray-200 bg-surface px-3 py-1.5 text-sm font-medium text-gray-700 shadow-xs transition hover:bg-gray-50 focus:outline-hidden focus:ring-2 focus:ring-blue-100";
...
export const inputClass =
  "rounded-lg border border-gray-300 bg-surface px-3 py-2 text-sm text-gray-900 transition placeholder:text-gray-400 focus:border-blue-400 focus:outline-hidden focus:ring-2 focus:ring-blue-100";
...
export const modalPanelClass = "w-full rounded-2xl bg-surface p-6 shadow-2xl ring-1 ring-black/5";

export const popoverClass =
  "rounded-xl border border-gray-200 bg-surface p-1 shadow-lg ring-1 ring-black/5";
...
export const tdClass = "px-3 py-2 border-b border-gray-100 text-gray-700";
